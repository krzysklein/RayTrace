...
namespace RayTrace
{
    public class Vector
    {
        ...
        public static Vector operator*(Vector vec, double times){
            return Vector.Times(times, vec);
        }
        public static Vector operator*(double times, Vector vec){
            return Vector.Times(times, vec);
        }
        public static Vector operator+(Vector vecA, Vector vecB){
            return Vector.Plus(vecA, vecB);
        }
        public static Vector operator-(Vector vecA, Vector vecB){
            return Vector.Minus(vecA, vecB);
        }
    }
}
